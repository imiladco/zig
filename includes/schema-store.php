...
final class Schema_Store {
    ...
    /**
     * گروه‌های فیلترِ یک دسته — تنها راهِ درستِ پرسیدن این سؤال.
     *
     * این متد از یک باگِ نصب واقعی متولد شد و ارزش تعریف‌کردن دارد.
     * ‎Archive_Head‎ و ویجت هر دو همین را می‌پرسیدند، ولی هرکدام جور خودش:
     * ویجت با کشفِ ویژگی‌ها و ‎Archive_Head‎ با آرایهٔ خالی. نتیجه‌اش این
     * شد که روی فروشگاهی که هنوز طرحی ذخیره نکرده، ویجت گروه‌ها را ‎OR‎
     * می‌دید و ‎Archive_Head‎ ‎AND‎.
     *
     * و خرابی‌اش بی‌صدا نبود، فاجعه بود: کاربر روی برند دوم کلیک می‌کرد،
     * سایدبار لینکی با ‎query_type_brand=or‎ می‌ساخت، ‎Archive_Head‎ آن را
     * «مخالف طرح» می‌دید و با ‎302‎ پارامتر را برمی‌داشت — و آدرسِ مقصد با
     * معنای ‎AND‎ هیچ محصولی نداشت و ‎404‎ می‌گرفت. یعنی دومین کلیک روی هر
     * فیلتری، به یک صفحهٔ ۴۰۴ می‌رسید.
     *
