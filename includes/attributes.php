...
final class Attributes {
     ...
     *
     * وقتی نیست، مسیر جایگزین (رابطهٔ ترم‌ها) کار می‌کند ولی عددهایش دقیقاً
     * همان نیستند: ویژگی‌های سطح گزینه دیده نمی‌شوند. این تفاوت باید در
     * پنل گفته شود، نه اینکه بی‌صدا بماند.
     */
