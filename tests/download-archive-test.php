...
Tests::ok('Frontend asset version was advanced for the current widget assets', false !== strpos(file_get_contents($root . '/zig3d-elementor-widgets.php'), "define('ZIG3D_WIDGETS_VERSION', '1.19.1')"));
